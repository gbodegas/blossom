...
school disagrees with the record. Nothing is filtered out. The same set
carries the household's standing rules about how she works and one note the
planner kept about a past plan, so a run of the planner has both to read.
